<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Tạo nhóm quản trị</li>
    </ol>
</section>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="checkbox clearfix">
                            <label title="{{$v['permission_name']}}">
                                <input  type="checkbox" value="{{$v['permission_id']}}" name="permission_id[]" @if(isset($data['strPermission'])) @if(in_array($v['permission_id'],$data['strPermission'])) checked @endif @endif>  {{$v['permission_code']}}
                            </label>
                        </div>
                        @endforeach
                        </div>
