...
var objStorage = localStorage.getItem("objDataProductAdmin");
...
CKEDITOR.instances.product_extra_short_desc.on('key', function (e) {
    delaySomethings(function(){
        ...
        localStorage.setItem("objDataProductAdmin",JSON.stringify(objStorage));
    },500);
});
...
$(function(){
    ...
    $("#deleteDraft").on("click",function(){
        localStorage.removeItem("objDataProductAdmin");
    });
});
