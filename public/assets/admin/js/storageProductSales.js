var objStorage = localStorage.getItem("objDataProductSalesAdmin");
...
$(function(){
    ...
    $("#product_price_sale").on("keyup",function(){
        ...
        delaySomethings(function(){
            ...
            localStorage.setItem("objDataProductSalesAdmin",JSON.stringify(objStorage));
        },0);
    });
    ...
    $("#deleteDraft").on("click",function(){
        localStorage.removeItem("objDataProductSalesAdmin");
    });
});