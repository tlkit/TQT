...
class Export extends Eloquent{
    ...
    protected $fillable = array('export_code','customers_id','sale_list_id','export_customers_address','export_customers_name', 'export_customer_phone', 'export_customers_note','export_delivery_time','export_user_store','export_user_cod', 'export_user_customer','export_subtotal','export_total','export_total_pay','export_discount','export_discount_customer','export_vat','export_price_origin','export_status','export_note','export_pay_type','export_create_id','export_create_time','export_update_id','export_update_time');
