...
class ImportProductFake extends Eloquent{
    ...
    protected $fillable = array('import_id','product_id','providers_id','import_product_price','import_product_num','import_product_total','import_product_create_id','import_product_create_time','import_product_update_id','import_product_update_time','import_product_status','import_product_type');
    ...
    public static function getProductByImportId($import_id){
        $data = ImportProductFake::where('import_id',$import_id)->lists('product_id');
        return $data;
    }
