<div class="main-content-inner">
    <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Hóa đơn xuất kho ảo</li>
        </ul><!-- /.breadcrumb -->
    </div>
                            ...
                            <tr id="{{$item['export_code']}}" @if($item['export_status'] == 0)class="orange bg-warning" @endif>
                                ...
                                <td>
                                    @if($item['export_status'] == 1)
                                        <a href="{{URL::route('admin.export_fake_detail',array('id' => base64_encode($item['export_id'])))}}" class="btn btn-xs btn-primary" data-content="Chi tiết hóa đơn" data-placement="bottom" data-trigger="hover" data-rel="popover">
                                        ...
                                        <a href="{{URL::route('admin.export_fake_exportPdf',array('id' => base64_encode($item['export_id'])))}}" target="_blank" class="btn btn-xs btn-danger" data-content="Xuất pdf" data-placement="bottom" data-trigger="hover" data-rel="popover">
