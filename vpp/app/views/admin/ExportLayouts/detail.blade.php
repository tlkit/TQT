<div class="main-content-inner">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{URL::route('admin.export_view')}}">Danh sách xuất kho</a>
            </li>
    ...
    <div class="page-content">
        ...
        <div class="col-sm-12 text-center padding-10">
            ...
            <a href="{{URL::route("admin.export_exportPdf",array('id' => base64_encode($export['export_id'])))}}" target="_blank" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> XUẤT PDF</a>
        </div>
