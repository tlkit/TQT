    ...
    <table class="table table-striped table-bordered">
        ...
        @foreach($export as $k => $v)
            ...
            <tr>
                ...
                <td class="center">
                    <a href="javascript:void(0)" class="btn btn-xs btn-danger sys_remove_item" onclick="Export.removeItem({{$k}})" data-content="Bỏ sản phẩm" data-placement="bottom" data-trigger="hover" data-rel="popover">
