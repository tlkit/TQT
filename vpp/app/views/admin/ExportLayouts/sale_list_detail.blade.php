<div class="main-content-inner">
    ...
    <div class="page-header">
        <div class="text-right">
            <a target="_blank" href="{{URL::route('admin.sale_list_pdf',array('id'=>base64_encode($sale_list['sale_list_id'])))}}" class="btn btn-danger btn-sm" style="margin-right: 15px"><i class="ace-icon fa fa-file-pdf-o"></i> Xuất bảng kê</a>
            <a href="{{URL::route('admin.exportExcelReportSaleList',array('id'=>base64_encode($sale_list['sale_list_id'])))}}" class="btn btn-success btn-sm" style="margin-right: 15px"><i class="ace-icon fa fa-file-excel-o"></i> Xuất excel</a>
        </div>
    </div>
    <!-- /.page-header -->
