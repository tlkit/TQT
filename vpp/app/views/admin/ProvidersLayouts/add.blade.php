<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{URL::route('admin.customers_list')}}"><i class="fa fa-user-md"></i> Danh sách khách hàng</a></li>
...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group col-sm-4">
            ...
            <select name="customers_ManagedBy" id="customers_ManagedBy" class="form-control input-sm">
                @foreach($user as $k2 => $v2)
                    <option value="{{$k2}}" @if(isset($data['customers_ManagedBy']) && $data['customers_ManagedBy'] == $k2)selected="selected" @endif>{{$v2}}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" id="customers_ContractNo" name="customers_ContractNo" class="form-control input-sm"
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" id="customers_ContactName" name="customers_ContactName" class="form-control input-sm"
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" id="customers_ContactPhone" name="customers_ContactPhone" class="form-control input-sm"
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" id="customers_ContactEmail" name="customers_ContactEmail" class="form-control input-sm"
                   value="@if(isset($data['customers_ContactEmail'])){{$data['customers_ContactEmail']}}@endif">
        </div>
        <div class="form-group col-sm-6">
            <div>
                <label for="customers_BizAddress">Địa chỉ ĐKKD</label>
        ...
        <div class="form-group col-sm-6">
            <div>
                <label for="customers_ContactAddress">Địa chỉ thực tế</label>
