                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="chosen-select form-control" id="customers_id" name="customers_id" data-placeholder="Ch?n khách hàng">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <label for="product_name"><i>Tên s?n ph?m</i></label>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="space"></div>
                                            <input type="button" class="btn btn-sm btn-primary" id="sys_add_product" value="Thêm s?n ph?m"/>
                                        </div>
                                    </div>
                                    <div class="space"></div>
