<div class="main-content-inner">
    <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Thống kê bán hàng khách không lấy VAT</li>
        </ul><!-- /.breadcrumb -->
    </div>
                ...
                @if(sizeof($data) > 0)
                    <table class="table table-bordered">
                        ...
                        <tr class="">
                            ...
                            <th class="center" width="8%">Mã SP</th>
                            <th class="center" width="30%">Tên SP</th>
                            <th class="center" width="25%">Khách hàng</th>
                        ...
                        @foreach ($data as $key => $item)
                            <tr>
                                ...
                                <td class="text-left">{{$item['export_customers_name']}}</td>
