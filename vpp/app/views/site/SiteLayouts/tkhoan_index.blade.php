            ...
            <div class="cl make-left">
                <div class="box-left clearfix">
                    ...
                    <ul class="rs user-list">
                        <li class="">
                            <i class="icons iRightU"></i><a href="">Quản lý tài khoản</a>
                        </li>
                        <li class="">
                            <i class="icons iRightU"></i><a href="">Đổi mật khẩu</a>
                        </li>
                        <li class="">
                            <i class="icons iRightU"></i><a href="">Quản lý đơn hàng</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="box-right-user clearfix">
                        ...
                        <div class="user-frm clearfix">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="txt width-535" placeholder="adsfdf dgfgfg">
                            </div>
                            <div class="form-group">
                                <input type="button" value="Lưu lại" class="btn btn-submit">
                            </div>
                        </div>
                    </div>
                </div>
