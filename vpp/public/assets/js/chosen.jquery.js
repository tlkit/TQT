    ...
    AbstractChosen.prototype.strip_diacritics = function (string) {
      var
          translationTable = [
              ...
              "áàạãÀÁÃẠâấầậẫÂẦẤẬẪăắằặẵĂẮẰẶẴéèẹẽÉÈẼẸêếềễệÊẾỀỆỄíìịĩÍÌỊĨóòọõÓÒỌÕôốồộỗÔỐỒỘỖơớờợỡƠỚỜỢỠúùụũÚÙỤŨưứừựữƯỨỪỰỮýỳỵỹÝỲỴỸ",
              // stripped output
              "aaaaAAAAaaaaaAAAAAaaaaaAAAAAeeeeEEEEeeeeeEEEEEiiiiIIIIooooOOOOoooooOOOOOoooooOOOOOuuuuUUUUuuuuuUUUUUyyyyYYYY",
          ],
          output = '';
