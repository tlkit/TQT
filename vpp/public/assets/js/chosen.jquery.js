    ...
    AbstractChosen.prototype.strip_diacritics = function (string) {
      var
          translationTable = [
              ...
              "áàạãảÀÁÃẠẢâấầậẩẫÂẦẤẬẪẨăắằặẵẳĂẮẰẶẴẲéèẹẽẻÉÈẼẸẺêếềễệểÊẾỀỆỄỂíìịĩỉÍÌỊĨỈóòọõỏÓÒỌÕỎôốồộỗổÔỐỒỘỖỔơớờợỡởƠỚỜỢỠỞúùụũủÚÙỤŨỦưứừựữửƯỨỪỰỮỬýỳỵỹỷÝỲỴỸỶ",
              // stripped output
              "aaaaaAAAAaaaaaaaAAAAAAaaaaaaAAAAAAeeeeeEEEEEeeeeeeEEEEEEiiiiiIIIIIoooooOOOOOooooooOOOOOOooooooOOOOOOuuuuuUUUUUuuuuuuUUUUUUyyyyỷYYYYỶ",
          ],
          output = '';
